...
bind("n", "<leader>rc", "<Cmd>e ~/dotFiles/Neovim/.config/nvim/init.lua<CR>", { desc = "Edit config" })

-- File Explorer
bind("n", "<leader>m", "<Cmd>NvimTreeFocus<CR>", { desc = "Focus on File Explorer" })
bind("n", "<leader>t", "<Cmd>NvimTreeToggle<CR>", { desc = "Toggle File Explorer" })
